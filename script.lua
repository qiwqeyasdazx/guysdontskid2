...
local T1UIColor = {
    ["Border Color"] = Color3.fromRGB(0, 220, 255),
    ["Click Effect Color"] = Color3.fromRGB(0, 220, 255),
    ["Setting Icon Color"] = Color3.fromRGB(200, 200, 200),
    ["Logo Image"] = "rbxassetid://5009915795",
    ["Search Icon Color"] = Color3.fromRGB(0, 220, 255),
    ["Search Icon Highlight Color"] = Color3.fromRGB(0, 180, 220),
    ...
    ["Title Text Color"] = Color3.fromRGB(0, 220, 255),
    
    ["Background Main Color"] = Color3.fromRGB(0, 0, 0), 
    ["Background 1 Color"] = Color3.fromRGB(5, 5, 5),
    ["Background 1 Transparency"] = 0,
    ["Background 2 Color"] = Color3.fromRGB(8, 8, 8),
    ["Background 3 Color"] = Color3.fromRGB(5, 5, 5),
    ["Background Image"] = "",
    
    ["Page Selected Color"] = Color3.fromRGB(0, 220, 255),
    ["Section Text Color"] = Color3.fromRGB(0, 220, 255),
    ["Section Underline Color"] = Color3.fromRGB(0, 220, 255),
    ["Toggle Border Color"] = Color3.fromRGB(70, 70, 70),
    ["Toggle Checked Color"] = Color3.fromRGB(0, 220, 255),
    ["Toggle Desc Color"] = Color3.fromRGB(180, 180, 180),
    
    ["Button Color"] = Color3.fromRGB(0, 220, 255),
    ["Label Color"] = Color3.fromRGB(0, 220, 255),
    ["Dropdown Icon Color"] = Color3.fromRGB(0, 220, 255),
    ["Dropdown Selected Color"] = Color3.fromRGB(0, 220, 255),
    ["Dropdown Selected Check Color"] = Color3.fromRGB(0, 220, 255),
    
    ["Textbox Highlight Color"] = Color3.fromRGB(0, 220, 255),
    ["Box Highlight Color"] = Color3.fromRGB(0, 220, 255),
    ["Slider Line Color"] = Color3.fromRGB(8, 8, 8),
    ["Slider Highlight Color"] = Color3.fromRGB(0, 220, 255),
...
mainButton.Image = "rbxassetid://112518061635682"
...
icon.Image = "rbxassetid://112518061635682"
icon.Visible = false
...
Library.ToggleUI = function()
    ...
    local targetColor = isToggled and Color3.fromRGB(0, 0, 0) or Color3.fromRGB(5, 5, 5)
...
function Library:CreateWindow(Setting)
	...
	maingui.ImageColor3 = Color3.fromRGB(0, 220, 255)
	...
	uistr.Thickness = 1;
	uistr.Color = Color3.fromRGB(0, 220, 255);
	...
	TopStroke.BackgroundColor3 = Color3.fromRGB(0, 220, 255)
	TopStroke.BackgroundTransparency = 0.3
   ...
   TextLabelMain.Text = "<font color=\"rgb(0, 220, 255)\">" .. tostring(TitleNameMain or "Banana Hub") .. "</font> <font color=\"rgb(255,255,255)\">" .. tostring(getgenv().MainDesc or "") .. "</font>"
	...
	pageControlStroke.Color = Color3.fromRGB(0, 220, 255)
	...
	local PageCounter = 1
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			sectionStroke.Color = Color3.fromRGB(0, 220, 255)
			...
			local sectionFunction = {}
				...
				check.BackgroundColor3 = Color3.fromRGB(0, 220, 255)
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				ClickArea_1.BackgroundColor3 = Color3.fromRGB(0, 220, 255)
